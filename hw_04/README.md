...
![Свойства Ethernet PC-A](![PC-A](PC-A.png))
![Свойства Ethernet PC-B](![PC-B](PC-B.png))

b. Убедился, что оба компьютера имеют правильную информацию адреса IPv6.
*Каждый компьютер должен иметь два глобальных адреса IPv6: один статический и один SLACC*
